...
async function main(): Promise<void> {
  ...
  // Se listan los correos porque con seis perfiles, recordar cual era el
  // correcto en mitad de la demo es friccion que no hace falta. Las
  // contraseñas NO se imprimen: vienen de SEED_* y no tienen por que acabar
  // en un log ni en el historial de la terminal.
  console.log('Login de talentos (contraseña en SEED_TALENT_PASSWORD):');
  for (const t of TALENTOS) {
